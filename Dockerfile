...
LABEL Description="Minimal Docker image with Ergogen, Freerouting (2.0.1), and KiCad ${kicad_ver} with KiBot and other automation scripts" \
...
RUN wget https://github.com/freerouting/freerouting/releases/download/v2.0.1/freerouting-2.0.1.jar && \
