...
ARG FREEROUTING_URL=https://github.com/freerouting/freerouting/releases/download/v2.1.0/freerouting-2.1.0.jar
...
RUN wget ${FREEROUTING_URL} -O /opt/freerouting.jar
